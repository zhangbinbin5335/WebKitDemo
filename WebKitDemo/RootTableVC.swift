...
class RootTableVC: UITableViewController {
    ...
    var dataArray : [(title: String, className: String)] = []
    
    override func viewDidLoad() {
        super.viewDidLoad()

        self.title = "WebKitDemo"
        dataArray = [("WKWebViewDemo","WKWebViewVC")]
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let dataInfo = dataArray[indexPath.item]
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let dataInfo = dataArray[indexPath.item]
        if(dataInfo.className == "WKWebViewVC"){
            
            let vc = WKWebViewVC.init(nil)
